...
def plane(passengers):
    banned = ["нож", "бензин", "граната", "пистолет"]
    accepted = ()
    record = ()
    for passenger in passengers:
        ...
        for item in passenger["ручная кладь"]:
            if item in banned:
                print("Обнаружен запрещённый предмет", item, passenger["имя"])
                break
        else:
            print("Пассажир ", passenger["имя"], " допущен на рейс")
